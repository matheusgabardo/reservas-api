            ...
            <table
                ...
                <tbody>
                    <tr class="border-b border-neutral-200 dark:border-white/10">
                        ...
                        <td class="whitespace-nowrap  px-6 py-4">user@mail.dev</td>
                        <td class="whitespace-nowrap  px-6 py-4">User</td>
                        <td class="whitespace-nowrap  px-6 py-4">
                            <button type="button" class="px-4 py-1 rounded-sm bg-stone-950 cursor-pointer hover:bg-stone-500">Excluir</button>
                        </td>
                    </tr>
                </tbody>
            </table>
